...
internal fun String?.isWhiteContentType(): Boolean {
...
internal fun String?.isWhiteHosts(): Boolean {
...
internal fun String?.isBlackHosts(): Boolean {
...
internal fun String?.isSkipInterceptByHost(): Boolean {
...
internal fun String?.isIpAddress(): Boolean {
    if (this.isNullOrBlank()) return false
